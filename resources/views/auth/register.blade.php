            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="position_type" class="col-md-4 col-form-label text-md-right">立場</label>

                            <div class="col-md-6">
                                <select id="position_type" name="position_type" class="form-control">
                                    <option value="">プランナー</option>
                                    <option value="1">新郎</option>
                                    <option value="2">新婦</option>
                                </select>
                            </div>
                        </div>
